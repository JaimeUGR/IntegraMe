...
package com.integrame.app.ui.theme.palettes.candy
...
val md_theme_light_primary = Color(0xFF7449A8)
...
val md_theme_light_secondaryContainer = Color(0xFFFDD6FF)
...
val md_theme_light_surfaceTint = Color(0xFF7449A8)
val md_theme_light_outlineVariant = Color(0xFFCCC4CF)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFFDAB9FF)
val md_theme_dark_onPrimary = Color(0xFF431376)
val md_theme_dark_primaryContainer = Color(0xFF5B2F8E)
val md_theme_dark_onPrimaryContainer = Color(0xFFEEDBFF)
val md_theme_dark_secondary = Color(0xFFF4AEFF)
val md_theme_dark_onSecondary = Color(0xFF4F155E)
val md_theme_dark_secondaryContainer = Color(0xFF682E76)
val md_theme_dark_onSecondaryContainer = Color(0xFFFDD6FF)
